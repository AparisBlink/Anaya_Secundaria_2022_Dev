	...
	Anaya_Secundaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Ol.06.abc Bold', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-6' } },
				{ name: 'Ol.07.abc Color', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-7' } },
				{ name: 'Ol.08.abc Parentesis', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-8' } },
				{ name: 'Ol.09.abc Par.Bold', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-9' } },
				{ name: 'Ol.10.abc Par.Color', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-10' } },
