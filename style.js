	...
	Anaya_Secundaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: ' T.12 Act 2', element: 'h3', attributes: { 'class': 'bck-title-12'} },
				{ name: ' T.13 Act 3', element: 'h3', attributes: { 'class': 'bck-title-13'} },
				{ name: ' T.14 Act 4', element: 'h3', attributes: { 'class': 'bck-title-14'} },
