	...
	Anaya_Secundaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'E.01 Color auto', element: 'p', attributes: { 'class': 'bck-enfasis-1'} },
				{ name: 'E.02 Subrayado', element: 'p', attributes: { 'class': 'bck-enfasis-2'} },
				{ name: 'E.03 Sombreado', element: 'p', attributes: { 'class': 'bck-enfasis-3'} },
				{ name: 'E.04 Serif', element: 'p', attributes: { 'class': 'bck-enfasis-4'} },
				{ name: 'E.05', element: 'p', attributes: { 'class': 'bck-enfasis-5'} },
                { name: 'E.06', element: 'p', attributes: { 'class': 'bck-enfasis-6'} },
				{ name: 'E.07', element: 'p', attributes: { 'class': 'bck-enfasis-7'} },
				{ name: 'E.08', element: 'p', attributes: { 'class': 'bck-enfasis-8'} },
				{ name: 'E.09', element: 'p', attributes: { 'class': 'bck-enfasis-9'} },
				{ name: 'E.10', element: 'p', attributes: { 'class': 'bck-enfasis-10'} },
				{ name: 'E.11', element: 'p', attributes: { 'class': 'bck-enfasis-11'} },
				{ name: 'E.12', element: 'p', attributes: { 'class': 'bck-enfasis-12'} },
				{ name: 'E.13', element: 'p', attributes: { 'class': 'bck-enfasis-13'} },
				{ name: 'E.14', element: 'p', attributes: { 'class': 'bck-enfasis-14'} },
				{ name: 'E.15', element: 'p', attributes: { 'class': 'bck-enfasis-15'} },
				{ name: 'E.16', element: 'p', attributes: { 'class': 'bck-enfasis-16'} },
				{ name: 'E.17', element: 'p', attributes: { 'class': 'bck-enfasis-17'} },
				{ name: 'E.18', element: 'p', attributes: { 'class': 'bck-enfasis-18'} },
				{ name: 'E.19', element: 'p', attributes: { 'class': 'bck-enfasis-19'} },
				{ name: 'E.20', element: 'p', attributes: { 'class': 'bck-enfasis-20'} },
				{ name: 'E.21', element: 'p', attributes: { 'class': 'bck-enfasis-21'} },
				{ name: 'E.22', element: 'p', attributes: { 'class': 'bck-enfasis-22'} },
